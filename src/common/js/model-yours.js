...
(function (exports) {
    ...
    function YoursMediaModel(appSettings, app) {
        ...
        this.loadInitialData = function (dataLoadedCallback) {
            ...
            var requestData = {
                 url: appSettings.dataURL.replace(/:userid/, this.app.userId),
                 type: 'GET',
                 crossDomain: true,
                 dataType: 'json',
                 context : this,
        ...
        */
        this.handleJsonData = function (jsonData) {
            this.categoryData = [];
            this.currentCategory = 0;
            this.mediaData = this.formatMedia(jsonData);
            if (!jsonData.folders) {
        ...
        ***************************/
       /**
        * format data from Firebase for fireTV
        */
        this.formatMedia = function (jsonData) {
            var mediaData = [];
            for(var i = 0; i < jsonData.length; i++){
                var movie = jsonData[i];
                
                mediaData.push({
                    "id": movie._id, // "-LCeMVU2ssnYLofN-mys", // _id
                    "title": movie.name, // "Easter 2018", // name
                    "pubDate": movie.rawTimestamp, // "Mon, 21 Apr 2017 04:55:06 GMT", // rawTimestamp
                    "thumbURL": movie.streamingThumbnailUrl, // "https://yoursco-api-dev.mm1.cdn.yours.co/NC2VsnvILnQKP6nB2KPh9QhpoyV2/-LCeMVU2ssnYLofN-mys/thumb-00001-600k.png", // streamingThumbnailUrl
                    "imgURL": movie.streamingThumbnailUrl, // "https://yoursco-api-dev.mm1.cdn.yours.co/NC2VsnvILnQKP6nB2KPh9QhpoyV2/-LCeMVU2ssnYLofN-mys/thumb-00001-600k.png", //streamingThumbnailUrl
                    "videoURL": movie.streamingPlaylistUrl, // "https://yoursco-api-dev.mm1.cdn.yours.co/NC2VsnvILnQKP6nB2KPh9QhpoyV2/-LCeMVU2ssnYLofN-mys/master.m3u8", // streamingPlaylistUrl
                    "type": "video-live", // hard code (options: 'video', 'video-live')
                    "alwaysLive": true, 
                    "categories": [
                        "Magic Movies" // hard code
                    ],
    ...
    exports.YoursMediaModel = YoursMediaModel;
